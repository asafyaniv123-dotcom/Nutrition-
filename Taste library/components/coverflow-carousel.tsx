// Reference only. Pasted by Asaf on 19 Sep 2026 as a shadcn/React component.
// The app is one vanilla-JS HTML file, so nothing here is imported or built.
// Kept verbatim so the mechanism can be read, not so it can be installed.
// See coverflow-carousel.md beside it for what is worth taking.
"use client";
