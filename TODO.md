...
**עיוורון שראיתי בסורק הצבע, ורשום כאן:** הסורק קורא רק את מה שמצויר
ברגע הזה, אז אלמנט שתלוי במצב נעלם ממנו. שני כפתורים בתכנון זמן
(`wkAssign`/`moAssign`, הסרת שיוך) נצבעים ב-`--violet-300` ומופיעים רק
כשלמשימה יש תאריך — הסריקה הכריזה על תכנון זמן נקי והם היו שם.
